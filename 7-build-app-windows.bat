...
call reportgenerator "-title:Taskscheduler Library Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_lib_win.info" "-targetdir:docs/coverxygenlibwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_win"
...
call reportgenerator "-title:Taskscheduler Library Test Documentation Coverage Report (Windows)" "-reports:**/lcov_doxygen_test_win.info" "-targetdir:docs/coverxygentestwin" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_win"
...
echo Generate Test Coverage Data for Taskscheduler
call OpenCppCoverage.exe --export_type=binary:taskscheduler_tests_unit_win.cov --sources src\taskscheduler\src --sources src\taskscheduler\header --sources src\tests\taskscheduler -- build_win\build\Debug\taskscheduler_tests.exe

echo Generate Test Coverage Data for Taskscheduler App and Combine Results
call OpenCppCoverage.exe --input_coverage=utility_tests_unit_win.cov --input_coverage=taskscheduler_tests_unit_win.cov --export_type=cobertura:taskschedulerapp_unit_win_cobertura.xml --sources src\utility\src --sources src\utility\header --sources src\taskscheduler\src --sources src\taskscheduler\header --sources src\taskschedulerapp\src --sources src\taskschedulerapp\header --sources src\tests\utility --sources src\tests\taskscheduler -- build_win\build\Debug\taskschedulerapp.exe

echo Generate Unit Test Coverage Report
call reportgenerator "-title:Taskscheduler Library Unit Test Coverage Report (Windows)" "-targetdir:docs/coveragereportlibwin" "-reporttypes:Html" "-reports:**/taskschedulerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/taskscheduler/src;src/taskscheduler/header;src/taskschedulerapp/src;src/taskschedulerapp/header;src/tests/utility;src/tests/taskscheduler" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*" "-historydir:report_test_hist_win"
call reportgenerator "-targetdir:assets/codecoveragelibwin" "-reporttypes:Badges" "-reports:**/taskschedulerapp_unit_win_cobertura.xml" "-sourcedirs:src/utility/src;src/utility/header;src/taskscheduler/src;src/taskscheduler/header;src/taskschedulerapp/src;src/taskschedulerapp/header;src/tests/utility;src/tests/taskscheduler" "-filefilters:-*minkernel\*;-*gtest*;-*a\_work\*;-*gtest-*;-*gtest.cc;-*gtest.h;-*build*"
...
call robocopy src\taskscheduler\header "build_win\build\Release" /E
call robocopy src\taskschedulerapp\header "build_win\build\Release" /E
...
call robocopy src\taskscheduler\header "build_win\build\Debug" /E
call robocopy src\taskschedulerapp\header "build_win\build\Debug" /E
