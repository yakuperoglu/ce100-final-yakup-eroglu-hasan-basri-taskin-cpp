...
reportgenerator "-title:Taskscheduler Library Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_lib_linux.info" "-targetdir:docs/coverxygenliblinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_lib_hist_linux"
...
reportgenerator "-title:Taskscheduler Library Test Documentation Coverage Report (Linux)" "-reports:**/lcov_doxygen_test_linux.info" "-targetdir:docs/coverxygentestlinux" "-reporttypes:Html" "-filefilters:-*.md;-*.xml;-*[generated];-*build*" "-historydir:report_doc_test_hist_linux"
...
./publish_linux/bin/taskscheduler_tests
./publish_linux/bin/taskschedulerapp
...
cp -R src/taskscheduler/header build_linux/build/Release
...
cp -R src/taskscheduler/header build_linux/build/Debug
